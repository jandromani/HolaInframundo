...
const chosen=need.slice(0,runCap);const trace={version:'2.5.0',run_id:retrieval.run_id,generated_at:now.toISOString(),model:MODEL,candidates:need.length,selected:chosen.map(x=>x.m.id),searches:[],errors:[]};
